angular.module('ispeech', ['facebook', 'ui.bootstrap', 'ngSanitize'])
...
.controller('header', ['$scope', 'Facebook', ISPEECH.controller.header])
.controller('footer', ['websiteCopyWriting', ISPEECH.controller.footer])
.controller('index', ['$scope', 'AJAX', '$http', ISPEECH.controller.index])
.controller('article', ['$scope', '$sce', 'AJAX', ISPEECH.controller.article])
